...
namespace WinForms_LifePointsCalculator
{
    public partial class mainForm : Form
    {
        ...
        private void divideButton_Click(object sender, EventArgs e)
        {
            ...
            if (intPlayer1Input != p1DefaultInput)
            {
                intPlayer1Score = intPlayer1Score / intPlayer1Input; //perform the division
                player1Score.Text = intPlayer1Score.ToString(); //assign the converted int back to the text property  of player1Score
                player1Input.Text = p1DefaultInput.ToString(); //after the division operation reset the input text box to 0
            }

            if (intPlayer2Input != p2DefaultInput)
            {

                intPlayer2Score = intPlayer2Score / intPlayer2Input; //perform the division
                player2Score.Text = intPlayer2Score.ToString();
                player2Input.Text = p2DefaultInput.ToString(); //after the division operation reset the input text box to 0
